...
class GatewayService:
    ...
    hotel_rpc = RpcProxy('borobudur_hotel_jakarta')
    ...
    #search service
    @http('GET', '/hotel/room_type/<string:check_in_date>&<string:check_out_date>')
